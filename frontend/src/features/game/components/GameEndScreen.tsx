    ...
    return (
        <div className="min-h-screen bg-[#fbf7f2] flex items-center justify-center px-4 py-8">
            <div className="w-full max-w-2xl">
                <div className="rounded-2xl bg-white border border-[#ead8c6] shadow-xl p-12 text-center">
                    {isWon ? (
                        <>
                            <div className="text-6xl mb-4">🎉</div>
                            <h2 className="text-4xl font-extrabold text-[#2b1f17] mb-4">
                                Victory!
                            </h2>
                            <p className="text-lg text-[#6b5647] mb-8">
